    ...
    function (e) {
        ...
        function g(e) {
            ...
            return function e(t, a) {
                for (var r = t.firstChild; r; r = r.nextSibling) 3 === r.nodeType ? a += r.nodeValue.length : 1 === r.nodeType && (l.push({
                    ...
                    offset: a,
                    node: r
                }), a = e(r, a), h(r).match(/br|hr|img|input/) || l.push({
                    event: "stop",
                    offset: a,
                    node: r
                }));
            ...
            function r(e, t) {
                ...
                var a = function (e, t) {
                    ...
                    for (a = 0, r = t.c.length; a < r; a++)
                        if (y(t.c[a].bR, e)) return t.c[a].endSameAsBegin && (t.c[a].eR = (l = t.c[a].bR.exec(e)[0], new RegExp(l.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m"))), t.c[a]
                }(t, h);
        ...
        function t(e) {
            var t, a, r, l, o, n, i, s, d, c, u = function (e) {
                ...
                for (t = 0, r = (o = o.split(/\s+/)).length; t < r; t++)
                    if (p(l = o[t]) || k(l)) return l
            }(e);
        ...
        return l.highlight = C, l.highlightAuto = x, l.fixMarkup = b, l.highlightBlock = t, l.configure = function (e) {
            ...
            return r.c.push(l.PWM), r.c.push({
                cN: "doctag",
...
var current = location.pathname.split("http://uxcandy.co/").slice(-1)[0].replace(/^\/|\/$/g, "");
$(".navigation-menu li a", TemplateSidebar).each(function () {
    ...
    function (e) {
        ...
        if ($("#chartjs-polar-area-chart").length) {
            ...
            window.onload = function () {
                var e = document.getElementById("chartjs-polar-area-chart");
                window.myPolarArea = Chart.PolarArea(e, l)
            }
        }
        ...
        if ($("#chartjs-doughnut-chart").length) {
            var i = {
                ...
                s = $("#chartjs-doughnut-chart").get(0).getContext("2d");
            new Chart(s, {
                type: "doughnut",
                data: i,
                options: {
    ...
    function (e) {
        ...
        }), e("#descripcion").maxlength({
            warningClass: "badge mt-1 badge-success",
            limitReachedClass: "badge mt-1 badge-danger"
        }), e("#desc-gen").maxlength({
            warningClass: "badge mt-1 badge-success",
            limitReachedClass: "badge mt-1 badge-danger"
